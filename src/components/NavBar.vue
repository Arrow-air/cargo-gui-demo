<template>
  <nav
    class="flex items-center justify-between flex-wrap bg-gray-800 px-6 py-3 sticky top-0 z-50"
  >
    <div class="flex items-center flex-shrink-0 text-white mr-6">
      <span class="font-semibold text-xl tracking-tight">Arrow Cargo</span>
    </div>
